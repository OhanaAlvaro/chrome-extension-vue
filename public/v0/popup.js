document.addEventListener(
  ...
  function() {
    ...
    function time2ms(hms) {
      // Updated: now it expects/asumes: hh:mm:ss | hh:mm  (note: seconds may come with decimals, and that's ok)
    ...
    function pushIntoTable(scene, tableBody) {
      ...
      var row = `<tr>
          ...
          <td>
              <img class="action" src="img/preview.svg">
              <img class="action" src="img/delete.svg">
          </td>
        </tr>`
    ...
    function loadScenes(scenes) {
      ...
      scenes.sort(function(a, b) {
        var askip = includesAny(settings.skip_tags, a.tags)
        var bskip = includesAny(settings.skip_tags, b.tags)
